...
erpnext.hr.ExpenseClaimController = frappe.ui.form.Controller.extend({
	make_bank_entry: function() {
		var me = this;
		return frappe.call({
			method: "analytica_one.analytica_one.doctype.employee_expense_claim.employee_expense_claim.make_bank_entry",
			args: {
	...
	expense_type: function(frm, cdt, cdn) {
		...
		return frappe.call({
			method: "analytica_one.analytica_one.doctype.employee_expense_claim.employee_expense_claim.get_expense_claim_account",
			args: {
...
cur_frm.cscript.onload = function(doc,cdt,cdn) {
	...
	cur_frm.set_query("exp_approver", function() {
		return {
			query: "analytica_one.analytica_one.doctype.employee_expense_claim.employee_expense_claim.get_expense_approver"
		};
	});
}
...
frappe.ui.form.on("Employee Expense Claim Detail", {
...
frappe.ui.form.on("Employee Expense Claim", "employee_name", function(frm) {
